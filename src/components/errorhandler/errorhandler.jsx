...
const errorMessages = {
     ...
     1006: 'It does not not look like this place exist, maybe its in another system',
     ...
     9000: 'Error: Json body passed in bulk re... blah... blah... blah... Just contact the sys admin',
     9001: 'Error: Json body contains too ma re... blah... blah... blah... Just contact the sys admin',
